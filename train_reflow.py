...
class Flowmodel:
    ...
    def p_losses(self, denoise_fn, data_start, feat, t, noise=None):
        ...
        losses = ((target - eps_recon) ** 2).mean(
...
class Model(nn.Module):
    ...
    def gen_samples(
        ...
        return self.flow.p_sample_loop(
            self._denoise,
            shape=shape,
            device=device,
            feat=feat,
    ...
    def gen_sample_traj(
        ...
        return self.flow.p_sample_loop_trajectory(
            self._denoise,
            shape=shape,
            device=device,
            feat=feat,
...
def train(gpu, opt, output_dir, noises_init):
    ...
    for epoch in range(start_epoch, opt.niter):
        ...
        for i, data in enumerate(dataloader):
            ...
            x = [x0, x1]
            loss = model.get_loss_iter(x, feat, noises_batch).mean()
...
def parse_args():
    ...
    parser.add_argument(
        "--lr", type=float, default=2e-5, help="learning rate for E, default=0.0002"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        dest="latent_dim",
        default=2048,
        help="dimension size of latent vector",
    )
